...
public partial class Tut10Context : DbContext
{
    public Tut10Context()
    {
    }

    public Tut10Context(DbContextOptions<Tut10Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F6760CA459").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E71B730C914").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E388322388F").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D105343FB4361A").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F605259353").IsUnique();
